                ...
                {items.length > 4 ? 
                  <>
                    {items.slice(0,3).map(item => (
                      <li key={item.name}><Link href={item.href}><a href={item.href} className="hover:underline">{item.name}</a></Link></li>
                    ))}
                    <li className="relative">
                      ...
                      <ul className="absolute w-[200px] bg-gray-800 rounded shadow-2xl mt-4">
                        ...
                        <li key={item.name} className=" border-b border-white/5 last:border-0">
                          <Link href={item.href}>
                            <a href={item.href} className="flex py-3 px-6 hover:bg-gray-700/60">
                              {item.name}
                            </a>
                          </Link>
                        </li>
